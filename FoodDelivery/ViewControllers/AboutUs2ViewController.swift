...
extension AboutUs2ViewController {
    ...
    func getInfoHeaderSection() -> DSSection {
        ...
        // Title
        let title = DSLabelVM(.title2, text: "Best Pizza Restaurant in town")
...
extension AboutUs2ViewController {
    ...
    func getFeedbackSection() -> DSSection {
        ...
        let models = [0,1,2,4].map { (index) -> DSViewModel in
            ...
            // Text
            let text = DSTextComposer()
            text.add(type: .headline, text: faker.name, spacing: 5)
...
fileprivate let p1Image = URL(string: "https://images.pexels.com/photos/5490933/pexels-photo-5490933.jpeg?cs=srgb&dl=pexels-rachel-claire-5490933.jpg&fm=jpg")
