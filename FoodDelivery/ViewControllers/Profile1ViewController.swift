...
extension Profile1ViewController {
    ...
    func getGeographySection() -> DSSection {
        ...
        var changeLocation = action(title: "Change location", leftSymbol: "location")
    ...
    func getMemberShipSection() -> DSSection {
        ...
        var loyaltyCards = action(title: "Loyalty Cards", leftSymbol: "giftcard")
        loyaltyCards.didTap { [unowned self] (_ : DSActionVM) in
            self.pop()
        }
        
        var membership = action(title: "Membership", leftSymbol: "person.2")
        membership.didTap { [unowned self] (_ : DSActionVM) in
            self.pop()
        }
        
        var certificates = action(title: "Certificates", leftSymbol: "rectangle")
    ...
    func getProfileSettingsSection() -> DSSection {
        ...
        var notifications = action(title: "Notifications", leftSymbol: "bell")
        ...
        var passwordUpdate = action(title: "Password Update", leftSymbol: "lock")
    ...
    func getProfileDescription() -> DSSection {
        ...
        // Profile picture
        let picture = DSImageVM(imageUrl: URL.profileUrl(index: 8), height: .absolute(100), displayStyle: .circle)
